...
/// - `unknownChip` — UID не в пуле и `K24`-кода КП нет (код браслета `memberCode` не учитывается): чужая карта, чистый чип или устаревший пул.
/// - `kpChip` — UID не в пуле, но прочитан `K24`-код КП: судья тапнул чип КП вместо браслета.
