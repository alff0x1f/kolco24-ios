...
/// - `kpChip` — UID не в пуле, но прочитан `K24`-код КП: это чип КП, не браслет (тапнули не тот тип).
/// - `unknown` — UID не в пуле и кода КП нет: чужая гонка, чистый чип или устаревший пул.
